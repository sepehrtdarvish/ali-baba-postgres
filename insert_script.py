...
for _ in range(50):
    ...
    cur.execute("""
        INSERT INTO "Vehicle" (
            id, name, capacity, service, company, type
        ) VALUES (%s, %s, %s, %s, %s, %s)
    """, (
        vehicle_id, name, capacity, service_id, company, vehicle_type
    ))
...
for _ in range(100):
    ...
    vehicle_id = random.choice(vehicle_ids.keys())
    ...
    for i in 3:
        ...
        start_number = (seat_nums.pop(i-1) + 1) if i != 0 else 1
        end_number = seat_nums.pop(i)
        ...
        """, (
            seat_id, seat_nums.pop(0), seat_nums.pop(0), price, ticket_id
        ))
...
for _ in range(100):
    ...
    seat_id = random.choice(seat_ids.keys())
    ...
    cur.execute("""
        INSERT INTO "Reservation" (
            id, "user", seat, seat_number, is_cancelled
        ) VALUES (%s, %s, %s, %s, %s)
    """, (
